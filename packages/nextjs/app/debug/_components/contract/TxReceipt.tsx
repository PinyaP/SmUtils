...
export const TxReceipt = ({ txResult }: { txResult: TransactionReceipt }) => {
  ...
  return (
    <div className="flex text-sm rounded-3xl peer-checked:rounded-b-none min-h-0 bg-zinc-800 py-0">
      ...
      <div className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-content overflow-auto bg-zinc-800 rounded-t-none rounded-3xl !pl-0">
